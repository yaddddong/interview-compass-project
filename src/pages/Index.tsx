  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/10">
      ...
      <div className="flex max-w-full mx-auto">
        {/* 左侧筛选条件 - 仅桌面端显示 */}
        {!isMobile && (
          <div className="w-64 flex-shrink-0 bg-white/80 backdrop-blur-lg border-r border-gray-100/50 min-h-screen sticky top-14">
            <FilterSidebar 
              filters={filters} 
              onFiltersChange={setFilters}
        ...
        {/* 右侧主内容区域 */}
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-6 max-w-none">
          {/* 紧凑的难度滑动轴 */}
          <div className="mb-6">
            <DifficultySlider
